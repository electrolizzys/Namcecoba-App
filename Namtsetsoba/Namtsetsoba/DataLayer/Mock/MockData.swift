...
enum MockData {
    ...
    static let stores: [Store] = [
        Store(id: storeIDs[0], name: "Bread House", address: "Rustaveli Ave 12, Tbilisi",
              latitude: 41.6941, longitude: 44.8015, category: .bakery, rating: 4.7, openTime: "07:00", closeTime: "20:00"),
        Store(id: storeIDs[1], name: "Machakhela", address: "Aghmashenebeli Ave 28, Tbilisi",
              latitude: 41.7088, longitude: 44.7837, category: .restaurant, rating: 4.5, openTime: "10:00", closeTime: "23:00"),
        Store(id: storeIDs[2], name: "Nikora", address: "Chavchavadze Ave 5, Tbilisi",
              latitude: 41.7105, longitude: 44.7750, category: .grocery, rating: 4.2, openTime: "08:00", closeTime: "22:00"),
        Store(id: storeIDs[3], name: "Stamba Cafe", address: "Chubinashvili St 14, Tbilisi",
              latitude: 41.7070, longitude: 44.7920, category: .cafe, rating: 4.8, openTime: "09:00", closeTime: "21:00"),
        Store(id: storeIDs[4], name: "Entree", address: "Rustaveli Ave 22, Tbilisi",
              latitude: 41.6968, longitude: 44.8000, category: .cafe, rating: 4.6, openTime: "08:00", closeTime: "22:00"),
        Store(id: storeIDs[5], name: "Pasanauri", address: "Marjanishvili St 3, Tbilisi",
              latitude: 41.7110, longitude: 44.7880, category: .restaurant, rating: 4.4, openTime: "11:00", closeTime: "23:00"),
        Store(id: storeIDs[6], name: "Sweet Palace", address: "Pekini Ave 41, Tbilisi",
              latitude: 41.7220, longitude: 44.7680, category: .pastry, rating: 4.3, openTime: "09:00", closeTime: "20:00"),
        Store(id: storeIDs[7], name: "Sakhachapure N1", address: "Vake, Tbilisi",
              latitude: 41.7150, longitude: 44.7600, category: .bakery, rating: 4.1, openTime: "08:00", closeTime: "19:00"),
        Store(id: storeIDs[8], name: "Fresco", address: "Saburtalo, Tbilisi",
              latitude: 41.7250, longitude: 44.7550, category: .grocery, rating: 4.0, openTime: "08:00", closeTime: "23:00"),
        Store(id: storeIDs[9], name: "Lolita", address: "Vera, Tbilisi",
              latitude: 41.7020, longitude: 44.7900, category: .pastry, rating: 4.9, openTime: "10:00", closeTime: "21:00"),
    ]
